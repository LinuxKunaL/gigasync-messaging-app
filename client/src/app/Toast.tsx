...
const toastSuccess = (message: string) => {
  toast.custom(
    (t) => (
      <div className="flex relative gap-4 items-center justify-start p-4 dark:bg-bunker-920/40 backdrop-blur-md  border-[1px] dark:border-bunker-700/60 border-bunker-300/50 bg-bunker-50/60 rounded-md overflow-hidden">
...
const toastNotification = (NotificationMessage: TMessages) => {
  toast.custom(
    (t) => (
      <div className="flex relative gap-4 items-center justify-start p-4 dark:bg-bunker-920/40 backdrop-blur-md border-[1px] dark:border-bunker-700/60 border-bunker-300/50 bg-white rounded-md overflow-hidden">
        <div className="flex flex-row gap-4">
          ...
          />
          <div className="w-max">
            <Avatar rounded={false} data={NotificationMessage.sender} />
          </div>
